...
export function RenderPost({
  ...
  //   alert(JSON.stringify({a:item.post_id,b:current.post_id}))
  // }
  ...
  if (currentEvents == 'upcomming') {
    return (
      <View style={{flex: 1, width: responsiveWidth(100)}}>
        <ImageBackground
          style={{ width: responsiveWidth(100), flex: 1, justifyContent: 'center', alignItems: 'center' }}
        ...
        >
          ...
          <Text style={{ color: 'white', fontSize: responsiveFontSize(tablet ? 2 : 3), fontWeight: 'bold', textAlign: 'center', marginTop: responsiveFontSize(2) }}>{item.title}</Text>
          <Image
            style={{ width: responsiveFontSize(5), height: responsiveFontSize(5), borderRadius: responsiveFontSize(2.5), marginTop: responsiveFontSize(1) }}
...
function LiveModal({
  ...
  // console.log("sadfasdfasdfsadfsadf",currentEvents)
  ...
  console.log("carlist", cartList?.lineItems)
          ...
          <View style={{ ...styles.con, backgroundColor: 'white' }}>
            ...
            <View style={{ flex: 1, width: responsiveWidth(100) }}>
              <View style={{ flex: 1 }}>
                <View style={{ flex: 1 }}>
                  <FlatList
                    data={currentEvents == "upcomming" ? list.data : currentEvents.liveEvents?.data.map(it => {
                      return {
                        ...it,
                        // playbackUrl: "https://static.konnect.bio/900000005/posts/966087c6-d040-4ca3-b405-b0ea949222de.mp4#t=0.1",
                        children: children1,
                      }
                    })}
                    // initialNumToRender={
                    ...
                    // }
                    initialScrollIndex={currentEvents.index}
                    // onScrollEndDrag={()=>{
                  ...
                  />
                  {/* {currentEvents !== "upcomming" && (
                    <View style={{ width: '100%', flexDirection: 'row', position: 'absolute', bottom: 0, zIndex: 2 }}>
                      <View style={{ width: '33.33%', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginVertical: responsiveFontSize(0.5), borderColor: 'lightgray', borderRightWidth: 1 }}>
                        <EyeIcon color={"lightgray"} name="eye" size={responsiveFontSize(1.75)} />
                        <Text style={{ marginLeft: responsiveFontSize(0.75), fontSize: responsiveFontSize(1.5), color: 'white' }}>Views</Text>
                      </View>
                      <View
                        style={{
                          width: '33.33%',
                  ...
                  <View style={{ ...styles.con2, flex: tablet ? 1.3 : 1.75 }}>
                    <View style={{ width: '100%', flexDirection: 'row' }}>
                      <TouchableOpacity
                        ...
                        <Text style={{ fontSize: responsiveFontSize(tablet ? 1 : 1.5), fontWeight: 'bold', color: menu == "shop" ? "black" : "gray" }}>Shop</Text>
                      </TouchableOpacity>
                      <TouchableOpacity
                        // onPress={setMenu("chat")}
                        style={{ width: '25%', justifyContent: 'center', alignItems: 'center', paddingVertical: responsiveFontSize(0.5) }}>
                        <Text style={{ fontSize: responsiveFontSize(tablet ? 1 : 1.5), fontWeight: 'bold',color:'gray' }}>Chat</Text>
                      </TouchableOpacity>
                      <TouchableOpacity
                        // onPress={setMenu("details")}
                        style={{ width: '25%', justifyContent: 'center', alignItems: 'center', paddingVertical: responsiveFontSize(0.5) }}>
                        <Text style={{ fontSize: responsiveFontSize(tablet ? 1 : 1.5), fontWeight: 'bold',color:'gray' }}>Details</Text>
                      </TouchableOpacity>
                      <TouchableOpacity
...
export default connect(mapStateToProps, { ...myListAct, ...favAct, ...urlShortnerAct, ...liveActions })(LiveModal);
