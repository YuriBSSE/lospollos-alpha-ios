...
import TimeItem from '../afterAuth/User/ChildComponent/TimeItem';
let { width, height } = Dimensions.get('window');

export default function OurRestuarant({ navigation }) {
                        ...
                        <View style={styles.ctn1}>
                            <View style={{ width: '100%', justifyContent: 'center', alignItems: 'center', alignSelf:'center' }}>
                                <View style={{ width: '100%', alignSelf: 'center', justifyContent: 'space-around', height: responsiveFontSize(20), alignItems: 'center', }}>
                                    ...
                                    <View style={{
                                        width: '90%', height: responsiveFontSize(8),
                                ...
                                <View style={{ width: '100%' }}>
                                    <FlatList
                                        ...
                                        // style={{ alignSelf:'center', width: '100%', backgroundColor:'red',   }}
