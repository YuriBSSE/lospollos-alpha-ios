...
const AddCategory = ({ModalState, ChangeModalState}) => {
      ...
      <Modal
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <View style={{ flexDirection:'column', justifyContent:'space-between', alignItems:'center', height:responsiveFontSize(30), width:'90%' }}>
            <MyText
                    ...
                    decoration={'none'}
                    textAlign={'center'}
                    Label={'Veuillez entrer votre mot de passe pour accéder à cette catégorie '}
                    />
