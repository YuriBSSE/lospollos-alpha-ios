...
const SignUpVerficationModal = ({ModalState, ChangeModalState, callBack, navigation}) => {
              ...
              <TouchableOpacity
                ...
                <View
                  style={{
                    ...
                    shadowRadius: 3.84,
                    backgroundColor:
                    'first' == 'first' ? colors.themeblue : 'white',
                    elevation: 5,
                    alignSelf: 'center',
                    alignItems: 'center',
                    justifyContent: 'space-around',
                  ...
                  <Heading
                    width={'70%'}
                    color={'first' == 'first' ? 'white' : colors.themeblue}
...
export default SignUpVerficationModal;
