...
const OrderModal = ({ ModalState, ChangeModalState, nav }) => {
            ...
            <Modal
                ...
                <View style={styles.centeredView}>
                    <View style={styles.modalView}>
                        ...
                        <View style={{ flexDirection: 'column', justifyContent: 'space-between', alignItems: 'center', height: responsiveFontSize(10), width: '90%' }}>
                            <MyText
                                ...
                                decoration={'none'}
                                textAlign={'center'}
                                Label={'Choisissez Votre Type De Commande'}
                            />

                         
                        </View>
                        <View style={{ width: '100%', height: responsiveFontSize(10), justifyContent: 'space-between', alignItems: 'center', alignSelf: 'center', flexDirection:'row', }}>
                                <TouchableOpacity
                                    // onPress={()=> nav.navigate('ordernavigation')}
                                    style={[styles.button,{flexDirection:'row', justifyContent:'space-between', alignItems:'center'}]}>
                                    <Image resizeMode='contain' style={{width:80, height: 80}} source={require('../../assets/a2.png')} />
                                    <MyText
                                        style={{}}
                                        ...
                                        color={'white'}
                                        decoration={'none'}
                                        Label={'Récupérer ma commande'}
                                    />
                                </TouchableOpacity>
                                <TouchableOpacity
                                  onPress={()=> {
                                    ChangeModalState(false);
                                    nav.navigate('ordernavigation')
                                }}
                                               style={[styles.button,{flexDirection:'row', backgroundColor:'#BDBDBD'}]}>
                                               <Image resizeMode='contain' style={{width:50, height: 50}}  source={require('../../assets/a1.png')} />
                                    <MyText
                                        style={{}}
                                        size={responsiveFontSize(1.2)}
                                        fw={'bold'}
