    ...
    return (
        <View>
            ...
            <View
                ...
                <View style={{
                    height: responsiveFontSize(14), width: '40%',  justifyContent: 'center', alignItems: 'center'
                }}>
                    <View style={{ flexDirection: 'row', flexWrap: 'wrap', justifyContent:'flex-start', }}>
                        {[1, 2, 3].map(item => (
                            <View style={{
                                borderRadius: responsiveFontSize(1), padding: responsiveFontSize(0.1)
                            }}>
                                <Image
                                    resizeMode='cover'
                                    style={{
                        ...
                        <View style={{
                            borderRadius: responsiveFontSize(1), backgroundColor: '#b8b8b8', height: responsiveFontSize(6), width: 50, padding: responsiveFontSize(0.1), marginLeft:responsiveFontSize(0.1), justifyContent: 'center', alignItems: 'center'
                        }}>
